/**
 * Decorates the podcast-cards block
...
export default function decorate(block) {
  ...
  wrapper.className = 'podcast-cards-grid';
  ...
  Array.from(block.children).forEach((row) => {
    ...
    imgWrapper.className = 'podcast-cards-image';
    ...
    content.className = 'podcast-cards-content';
    ...
    card.className = 'podcast-cards-card';
